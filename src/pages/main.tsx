...
import { dataFormat_toMonth, onlyUnique } from "../assets/back_utils";
import teste from "../assets/global";
...
export const Main = () => {
    ...
    return(
        <View style={styles.page} onLayout={() => gettingEntradasSaida()}>
            <View style={{flexDirection:"row", width:'100%', display:"flex", justifyContent:"center"}}>
                <TouchableOpacity style={{position:"absolute", left: 10, top: 10}} onPress={() => {gettingEntradasSaida()}}>
                    <Reload height={35} width={35} color="black"/>
                </TouchableOpacity>
                <Text style={styles.title}>Controle de finanças</Text>
            </View>
